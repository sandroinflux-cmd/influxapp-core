...
export default function AuthPage() {
  ...
  return (
    <main className="h-screen w-full bg-[#010201] flex items-center justify-center p-6 overflow-hidden relative">
      ...
      {/* 1. NEON CORRIDOR (ეკრანის კიდეებზე მორბენალი ნათებები) */}
      ...
      >
        ...
        {/* 2. GIGANTIC 3D ORB BACKGROUND (ანიმაცია, რომელიც შემოხაზული გქონდა) */}
        ...
        <div className="relative z-10">
          {/* 3. INFLUX AESTHETIC LOGO (მონიშნულ ადგილას) */}
