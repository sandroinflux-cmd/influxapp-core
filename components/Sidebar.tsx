  ...
  return (
    <div className="h-screen w-72 bg-[#010201] border-r border-emerald-500/10 flex flex-col p-10 backdrop-blur-3xl sticky top-0 overflow-y-auto no-scrollbar">
      ...
      <div className="mb-20">
        ...
        <p className="text-[7px] font-black tracking-[0.6em] text-gray-500 uppercase mt-4">
        ...
        {menuItems.map((item) => {
          ...
          return (
            <Link key={item.name} href={item.path}>
              <motion.div
                whileHover={{ x: 8 }}
                className={`flex items-center gap-5 p-4 rounded-2xl transition-all duration-500 relative group ${
